(function(window){
  // interactive.js — standalone React component (no JSX).
  // Помістіть цей файл у папку resources і підключіть після React/ReactDOM.
  // Викликайте: mountInteractive('interactive-container')
  const React = window.React;
  const ReactDOM = window.ReactDOM;
  if (!React || !ReactDOM) {
    console.warn('React or ReactDOM not found. Please include React and ReactDOM before interactive.js');
  }
